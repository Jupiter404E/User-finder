...
file = open(f"cache\{args}.txt", "w")

## INSTAGRAM

check_Instagram = f"https://www.instagram.com/{args}/"
...
check_Facebook = f"https://www.facebook.com/{args}/"
...
check_Youtube = f"https://www.youtube.com/{args}/"
...
check_Twitch = f"https://www.twitch.tv/{args}/"
...
check_Twitter = f"https://twitter.com/{args}/"
...
check_Tiktok = f"https://www.tiktok.com/@{args}"

try:
    response = requests.head(check_Tiktok)
    if response.status_code == 200:
        print(Fore.GREEN + f"[+] TikTok: аккаунт найден! " + check_Tiktok)
        file.write("TikTok: " + check_Tiktok + "\n")
    if response.status_code == 404:
        print(Fore.YELLOW + "[-] TikTok: аккаунт не найден!")
    if response.status_code == 301:
        print(Fore.YELLOW + "[d] TikTok: аккаунт удалён!")
    if response.status_code == 403:
        print(Fore.RED + "[x] TikTok: доступ запрещён!")

except requests.ConnectionError:
    print(Fore.RED + "[e] TikTok: произошла ошибка")


## REDDIT

check_Reddit = f"https://www.reddit.com/user/{args}/"
...
check_Pinterest = f"https://www.pinterest.ca/{args}/"
...
check_Deviantart = f"https://www.deviantart.com/{args}/"
...
check_Github = f"https://github.com/{args}/"
...
check_Wordpress = f"https://{args}.wordpress.com/"
...
check_Flickr = f"https://www.flickr.com/photos/{args}/"
...
check_Soundcloud = f"https://soundcloud.com/{args}/"
...
check_Patreon = f"https://www.patreon.com/{args}/"
...
check_Ifttt = f"https://www.ifttt.com/p/{args}/"
...
check_Ebay = f"https://www.ebay.com/usr/{args}/"
...
check_Telegram = f"https://t.me/{args}/"
...
check_Replit = f"https://replit.com/{args}/"
...
check_Habr = f"https://qna.habr.com/user/{args}/"
...
check_Blogspot = f"https://{args}.blogspot.com/"
...
check_Tilda = f"http://{args}.tilda.ws/"
...
check_Donationalerts = f"https://www.donationalerts.com/r/{args}/"
...
print(Fore.CYAN + f"[\] cache\\{args}.txt")